...
{
  const { logout, savedrecipes, togglesaverecipe } = useContext(AuthContext);
  ...
  useEffect(() =>
  {
    const fetchRecipes = async () =>
    {
      try
      {
        ...
        {
          setRecipes(localFallbackRecipes);
        }
        setLoading(false);
      }
      catch (err)
      {
        console.error("Failed to load recipes, using fallback:", err);
        setRecipes(localFallbackRecipes);
        setLoading(false);
      }
    };
  ...
  const displayList = getFilteredRecipes();
    ...
    <div className="menu-page-container">
      ...
      <div className="menu-controls">
        ...
        <div className="category-filters">
          ...
          <button onClick={() => setSelectedCategory("starter")} className="category-btn">Starters</button>
          <button onClick={() => setSelectedCategory("main")} className="category-btn">Mains</button>
          <button onClick={() => setSelectedCategory("desert")} className="category-btn">Desserts</button>
          <button onClick={() => setSelectedCategory("sides")} className="category-btn">Sides</button>
        </div>
      </div>
      ...
      <div className="recipes-grid">
        ...
        {
          const isSaved = savedrecipes.some((item) => String(item.id) === String(recipe.id));
